...
#define PI 3.14159265359
	...
	Ref<Mesh> Mesh::CreatePrimitive(Primitive primitive)
	{
		switch (primitive)
		{
			case HPY::Primitive::Quad:				return Quad();
			case HPY::Primitive::FullScreenQuad:	return FullScreenQuad();
			case HPY::Primitive::Cube:				return Cube();
			case HPY::Primitive::Plane:				return Plane();
			case HPY::Primitive::Sphere:			return Sphere(1.0f);
			default: break;
		}
